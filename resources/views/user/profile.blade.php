    ...
    <body>
        ...
        <div class="wrapper registrationForm" id="profileForm">
            <div class="inner">
                ...
                <form class="d-flex justify-content-center registrationForm" id="studentForm" action="{{route('edit.profile', $user['id'])}}">
                    @csrf
                    @method('PUT')
                    <div>
                            ...
                            <div class="emailAndPassword mb-3 row ">
                                ...
                                <div class="col-lg-6 grade">
                                    ...
                                    <select name="grades" class="grades p-2" id="grades">
                                        @foreach( $grade as $g)
                                            <option value="{{$g->name}}" {{ $user['grade'] === $g->name ? 'selected' : ''}}>{{$g->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
